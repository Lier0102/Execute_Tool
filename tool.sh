...
toilet -f future "JUWON LIM" | lolcat
echo "-------------------------------------------------------" | lolcat
echo "Author : JUWON LIM $white" | lolcat
echo "Contact : https://www.facebook.com/profile.php?id=100042847774806 $white" | lolcat
echo "YouTube : GST $white" | lolcat
echo "-------------------------------------------------------" | lolcat
echo "			2.0		" | lolcat
...
echo ""
echo "╭─JUWON_LIM" | lolcat
read -p "╰──►" pil;

case $pil in
01) clear
toilet -f standard " JUWON " -F gay
...
14) clear
toilet -f standard " JUWON " -F gay
git clone https://github.com/TheSpeed/TBomb.git
cd TBomb
chmod +x TBomb.sh
./TBomb.sh
...
00) echo " created by : JUWON_LIM" | lolcat
exit
;;
